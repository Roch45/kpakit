def max_charges():
    ...
    # charges_max proprement dit 
    if N == 0 :

        if classe_profilé == 1 or classe_profilé == 2:

            print(f"Moment maximal au tour de y: {MRy/1000:.2f} N.m\nMoment maximal au tour de z: {MRz/1000:.2f} N.m")

        elif classe_profilé == 3:

            Mely = wely*fy
            Melz = welz*fy 
            print(f"Moment maximal au tour de y: {Mely/1000:.2f} N.m\nMoment maximal au tour de z: {Melz/1000:.2f} N.m")

        elif classe_profilé == 4:
            print(f"Moment maximal au tour de y: {Meffy/1000:.2f} N.m\nMoment maximal au tour de z: {Meffz/1000:.2f} N.m")
    elif N != 0:
        ...
        if classe_profilé == 1 or classe_profilé == 2:
            ...
            print(f"Moment maximal au tour de y: {abs(MNy)/1000:.2f} N.m\nMoment maximal au tour de z: {abs(MNz)/1000:.2f} N.m\nEffort normal maximal: {Npl:.2f}N")
            ...
            print(f"Moment maximal au tour de y: {Meffy/1000:.2f}N.m\nMoment maximal au tour de z: {Meffz/1000:.2f}N.m\nEffort normal maximal: {Aeff*fy:.2f} N")
